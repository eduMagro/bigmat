<x-app-layout>
    ...
    <div class="w-full px-2 sm:px-4 md:px-6 py-4">
        ...
        <div x-data="{ mostrarModal: false }">
            ...
            <div x-show="mostrarModal" x-cloak
                class="fixed inset-0 flex items-end md:items-center justify-center bg-gray-900 bg-opacity-50 dark:bg-opacity-70 z-50 p-0 md:p-4"
                    ...
                    <form method="POST" action="{{ route('alertas.store') }}" enctype="multipart/form-data"
                        ...
                        @if (auth()->user()->rol === 'oficina')
                            ...
                            <div class="mb-4">
                                ...
                                <select id="categoria" name="categoria" class="w-full border border-gray-200 dark:border-gray-700 rounded-lg p-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="mb-4">
                                ...
                                <select id="destinatario_id" name="destinatario_id"
                                    class="w-full border border-gray-200 dark:border-gray-700 rounded-lg p-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                            ...
                            <tr class="cursor-pointer transition-all duration-200 hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:shadow-md {{ $mostrarBadge ? 'bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-400' : 'bg-white dark:bg-gray-800' }}"
                                ...
                                <td class="px-4 py-3 text-center" onclick="event.stopPropagation()">
                                    @if ($alerta->tipo === 'entrante')
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 border border-green-200 dark:border-green-700">
                                    ...
                                    @else
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 border border-blue-200 dark:border-blue-700">
                                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path
                                    ...
                                    @if ($mostrarBadge)
                                        <div class="mt-1">
                                            <span
                                                class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-yellow-400 dark:bg-yellow-500 text-yellow-900 animate-pulse">
                                    ...
                                    <div class="flex items-start justify-between space-x-2">
                                        <div class="flex-1 min-w-0">
                                            ...
                                            @if (strlen($alerta->mensaje_completo) > strlen($alerta->mensaje_corto))
                                                <span
                                                    class="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium lg:hidden">
                                ...
                                <td class="px-4 py-3 text-center" onclick="event.stopPropagation()">
                                    <div class="flex justify-center space-x-2">
                                        @if ($alerta->tipo === 'vacaciones')
                                            <a href="{{ route('vacaciones.index') }}"
                                                class="inline-flex items-center px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium rounded-md transition-colors duration-150 shadow-sm hover:shadow-md"
                        ...
                        <div class="p-4 space-y-3"
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 border border-gray-200 dark:border-gray-600">
                                ...
                                <div class="flex items-center justify-between mt-2 lg:hidden">
                                    @if (strlen($alerta->mensaje_completo) > strlen($alerta->mensaje_corto))
                                        <button class="text-xs text-blue-600 dark:text-blue-400 font-medium flex items-center">
                            ...
                            <div class="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex space-x-2">
                                    @if ($alerta->tipo === 'vacaciones')
                                        <a href="{{ route('vacaciones.index') }}" onclick="event.stopPropagation();"
                                            class="inline-flex items-center px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium rounded-lg transition-colors duration-150 active:scale-95">
    ...
    @if ($esAdministrador)
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-6 md:mt-8 mb-4 gap-3">
            <h2 class="text-lg sm:text-xl md:text-2xl font-bold text-blue-900 dark:text-blue-400 flex items-center">
            ...
            <table class="w-full min-w-[1000px]">
                ...
                <tbody class="text-gray-700 dark:text-gray-300 text-sm">
                    @forelse ($todasLasAlertas as $alerta)
                        <tr
                            class="border-b border-gray-200 dark:border-gray-700 odd:bg-gray-50 dark:odd:bg-gray-700 even:bg-white dark:even:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors duration-150">
                            ...
                            <td class="p-3 text-center border-r border-gray-200 dark:border-gray-700">
                                @if ($alerta->destino)
                                    <span
                                        class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400 border border-purple-200 dark:border-purple-700">
                ...
                <div
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @if ($alerta->destino)
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400 border border-purple-200 dark:border-purple-700">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"
                                            clip-rule="evenodd" />
                            ...
                            @if ($alerta->destinatarioUser)
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-700">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path
                        ...
                        <!-- Mensaje -->
                        <div
                            class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-600 shadow-inner">
    ...
    <div id="modalVerMensaje" class="fixed inset-0 z-50 hidden" onclick="cerrarModalMensaje()">
        ...
        <div class="absolute inset-0 flex items-end md:items-center justify-center p-0 md:p-6">
            <div class="modal-content bg-white dark:bg-gray-800 w-full md:max-w-[440px] md:rounded-2xl shadow-2xl flex flex-col max-h-[100dvh] md:max-h-[80vh] overflow-hidden"
                ...
                <!-- Area de chat -->
                <div id="hiloContenido" class="flex-1 overflow-y-auto p-4 space-y-3 bg-gradient-to-b from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 min-h-[280px]">
                    <!-- Mensajes -->
                </div>

                <!-- Input -->
                <div class="bg-white dark:bg-gray-800 border-t border-slate-200 dark:border-gray-700 px-3 py-2 flex items-center gap-3 shrink-0">
                    <div class="flex-1 bg-slate-100 dark:bg-gray-700 rounded-2xl overflow-hidden transition-all duration-200 focus-within:bg-slate-50 dark:focus-within:bg-gray-600 focus-within:ring-2 focus-within:ring-emerald-500/30">
                        <textarea id="textoRespuesta"
                            class="w-full resize-none border-0 bg-transparent focus:ring-0 focus:outline-none text-[15px] text-slate-800 dark:text-gray-100 leading-6 placeholder-slate-400 dark:placeholder-gray-500 py-2.5 px-4 block"
    ...
    <div id="modalConfirmacionCambio"
        class="fixed inset-0 bg-black bg-opacity-60 dark:bg-opacity-70 hidden items-end md:items-center justify-center z-50 transition-opacity duration-300 p-0 md:p-4"
            ...
            <div class="p-4 md:p-6">
                <div class="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 p-3 md:p-4 rounded-r-lg mb-4">
                    <p class="text-sm md:text-base text-gray-800 dark:text-gray-200 mb-3">
                        Solicitud para elemento: <strong class="text-blue-700 dark:text-blue-400 text-base md:text-lg"><span
                    ...
                    <div
                        ...
                        <div class="flex items-center bg-red-100 dark:bg-red-900/30 px-3 py-2 rounded-lg w-full sm:w-auto justify-center">
                            <span class="text-red-700 dark:text-red-400 font-semibold">De: <span id="origenModal"></span></span>
                        </div>
                        ...
                        <div
                            class="flex items-center bg-green-100 dark:bg-green-900/30 px-3 py-2 rounded-lg w-full sm:w-auto justify-center">
                            <span class="text-green-700 dark:text-green-400 font-semibold">A: <span id="destinoModal"></span></span>
                        </div>
                    </div>
                </div>

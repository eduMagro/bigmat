<x-app-layout>
    ...
    <div class="px-2 sm:px-6 py-4" x-data="{
        ...
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300">Lista de Festivos ({{ $anioActual }})</h3>
                        ...
                        @forelse ($festivos as $festivo)
                            <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-gray-900 dark:text-gray-100 font-medium">{{ $festivo->fecha->format('d/m/Y') }}</span>
                                    <span class="text-gray-500 dark:text-gray-400 text-sm ml-2">({{ $festivo->fecha->translatedFormat('l') }})</span>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="text-gray-700 dark:text-gray-300">{{ $festivo->titulo }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        <button
                                            ...
                                            class="inline-flex items-center px-3 py-1.5 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 rounded-lg hover:bg-yellow-200 dark:hover:bg-yellow-900/50 transition-colors">
                                        ...
                                        <form action="{{ route('festivos.destroy', $festivo) }}" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="inline-flex items-center px-3 py-1.5 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-lg hover:bg-red-200 dark:hover:bg-red-900/50 transition-colors">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div x-show="openModal" x-cloak
            ...
            <div @click.away="openModal = false"
                ...
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100" x-text="editingId ? 'Editar Festivo' : 'Nuevo Festivo'"></h3>
                ...
                <form method="POST" :action="editingId ? '{{ url('festivos') }}/' + editingId : '{{ route('festivos.store') }}'"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="fecha" x-model="fecha" required
                            class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="titulo" x-model="titulo" placeholder="Ej: Navidad"
                            class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500">
                    </div>

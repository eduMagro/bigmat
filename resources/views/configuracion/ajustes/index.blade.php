        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-700">Empresas</h3>
            ...
            <div x-show="openEmpresaModal" x-cloak
                ...
                <div @click.away="openEmpresaModal = false"
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 mb-4" x-text="editingEmpresaId ? 'Editar Empresa' : 'Nueva Empresa'"></h3>
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-700">Categorias Profesionales</h3>
            ...
            <div x-show="openCategoriaModal" x-cloak
                ...
                <div @click.away="openCategoriaModal = false"
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 mb-4" x-text="editingCategoriaId ? 'Editar Categoria' : 'Nueva Categoria'"></h3>
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden" x-data="{
                    ...
                    <div x-show="openFestivoModal" x-cloak
                        ...
                        <div @click.away="openFestivoModal = false"
                            ...
                            <h3 class="text-xl font-semibold text-gray-800" x-text="editingFestivoId ? 'Editar Festivo' : 'Nuevo Festivo'"></h3>

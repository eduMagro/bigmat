        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center gap-4 mb-2">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Editar Turno: {{ $turno->nombre }}</h2>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                <form action="{{ route('turnos.update', $turno) }}" method="POST">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-3">
                        <a href="{{ route('turnos.index') }}" wire:navigate
                            class="px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            Cancelar
                        </a>
                        <button type="submit"

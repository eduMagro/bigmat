    ...
    <div class="m-4 text-center">
        <div class="inline-flex items-center justify-center gap-2 text-sm">
            ...
            <select wire:model.live="perPage"
                    id="perPageSelect"
                    class="border border-gray-300 dark:border-gray-600 rounded px-2 py-1 text-sm bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <nav class="inline-flex flex-wrap gap-1 bg-white dark:bg-gray-800 px-2 py-1 mb-6 rounded-md shadow-sm">
                        ...
                        @else
                            <button type="button"
                                    ...
                                    class="px-3 py-1 text-xs text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900 rounded transition disabled:opacity-50">
                                &laquo;
                            </button>
                        @endif
                        ...
                        @foreach ($pages as $page)
                            ...
                            {{-- Página actual --}}
                            @if ($page == $current)
                                <span class="px-3 py-1 text-xs font-bold bg-blue-600 dark:bg-blue-700 text-white rounded shadow border border-blue-700 dark:border-blue-600">
                                    {{ $page }}
                                </span>
                            @else
                                <button type="button"

...
<div x-data="modalClave('{{ $seccion }}')" x-init="verificarClaveSeccion()">
    ...
    <div x-show="mostrarModal" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 w-80 shadow-xl relative z-50">
            <h2 class="text-lg font-bold mb-4 text-center text-gray-900 dark:text-gray-100">Sección protegida</h2>

            <form @submit.prevent="enviarClave">
                <input type="password" x-model="clave" placeholder="Introduce la clave..."
                    class="w-full border border-gray-300 dark:border-gray-600 rounded px-3 py-2 mb-4 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400" autofocus />

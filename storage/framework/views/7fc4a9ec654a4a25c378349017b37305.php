<div x-data="agendaUsuarios(<?php echo \Illuminate\Support\Js::from($contactosAgenda ?? collect())->toHtml() ?>)" class="users-mobile md:hidden mt-4 space-y-3">
    <style>
    ...
    <div class="sticky top-0 z-20 bg-white border border-gray-200 shadow-sm rounded-lg">
        <div class="flex items-center gap-2 px-4 py-3">
            ...
            <a href="<?php echo e(route('incorporaciones.index')); ?>" class="flex-shrink-0 bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-xs font-medium flex items-center gap-1">
    ...
    <script>
        ...
        return {
            ...
            async guardarSeleccionado() {
                ...
                try {
                    const resp = await fetch(`<?php echo e(url('/users')); ?>/${this.seleccionado.id}`, {
                        method: 'POST',
                        headers: {
...
</div><?php /**PATH C:\xampp\htdocs\bigmat\resources\views/livewire/users-table-mobile.blade.php ENDPATH**/ ?>
...
<div x-data="{
    ...
    menuSectionIds: [<?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'<?php echo e($section['id']); ?>'<?php if(!$loop->last): ?>, <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>],
    menuItemCounts: { <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'<?php echo e($section['id']); ?>': <?php echo e(isset($section['submenu']) ? count($section['submenu']) : 0); ?><?php if(!$loop->last): ?>, <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> },
    ...
    updateActiveSection() {
        ...
        <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(isset($section['submenu'])): ?>
        <?php $__currentLoopData = $section['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        if (this.isRouteActive('<?php echo e(route($item['route'])); ?>')) {
            const id = '<?php echo e($section['id']); ?>';
            ...
            this.addToRecent('<?php echo e($item['route']); ?>', '<?php echo e($item['label']); ?>', '<?php echo e($section['label']); ?>', '<?php echo e($item['icon']); ?>', '<?php echo e(route($item['route'])); ?>');
        }
    ...
    performSearch() {
        ...
        <?php $__currentLoopData = $section['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        allItems.push({
            route: '<?php echo e($item['route']); ?>',
            label: '<?php echo e($item['label']); ?>',
            section: '<?php echo e($section['label']); ?>',
            icon: '<?php echo e($item['icon']); ?>',
            url: '<?php echo e(route($item['route'])); ?>'
        });
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="main-sidebar"
        ...
        <div class="px-4 h-14 flex items-center justify-around border-b border-gray-800 border-r-0 overflow-hidden">
            ...
            <a x-show="open && !isToggling"
               ...
               href="<?php echo e(route('dashboard')); ?>" wire:navigate
               class="sidebar-logo flex items-center space-x-3 group relative z-50">
                <?php if (isset($component)) { $__componentOriginal8892e718f3d0d7a916180885c6f012e7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8892e718f3d0d7a916180885c6f012e7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'block h-8 w-auto fill-current text-gray-800 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block h-8 w-auto fill-current text-gray-800 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition']); ?>
...
<?php endif; ?>
                ...
                <div x-show="showFavorites" x-cloak x-transition class="mt-2 space-y-1"
                    ...
                    <template x-for="fav in favorites" :key="fav.route">
                        <div
                            ...
                            <a :href="fav.url || `<?php echo e(url('/')); ?>${getRouteUrl(fav.route)}`"
                                wire:navigate
            ...
            <div class="relative">
                ...
                <div x-show="showRecent" x-cloak x-transition class="mt-2 space-y-1"
                    ...
                    <template x-for="page in recentPages.slice(0, 5)"
                        :key="page.route">
                        <a :href="page.url || `<?php echo e(url('/')); ?>${getRouteUrl(page.route)}`"
                            wire:navigate
        ...
        <nav
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-2">
                    <!-- Sección Principal -->
                    <div class="relative" id="menu-section-<?php echo e($section['id']); ?>">
                        <button
                            ...
                            @focus="focusedSectionId = '<?php echo e($section['id']); ?>'"
                            ...
                            :class="{
                                'bg-<?php echo e($section['color']); ?>-600 text-white shadow-lg': currentSectionId === '<?php echo e($section['id']); ?>',
                                'ring-2 ring-blue-400 ring-offset-1 ring-offset-gray-900': focusedSectionId === '<?php echo e($section['id']); ?>' && currentSectionId !== '<?php echo e($section['id']); ?>'
                            }">
                            <div class="flex items-center space-x-3">
                                <span
                                    class="text-xl flex-shrink-0"><?php echo e($section['icon']); ?></span>
                                <span x-show="open" x-cloak x-transition
                                    class="sidebar-text font-medium"><?php echo e($section['label']); ?></span>
                            </div>
                            <svg x-show="open" x-cloak
                                :class="activeSections.includes('<?php echo e($section['id']); ?>') ?
                                    'rotate-180' : ''"
                    ...
                    <!-- Submenú -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($section['submenu'])): ?>
                        <div x-show="open && activeSections.includes('<?php echo e($section['id']); ?>')"
                            x-transition
                            class="mt-2 ml-4 space-y-1 border-l-2 border-gray-700 pl-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $section['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['disabled'])): ?>
                                    
                                    <div class="flex items-center group" id="menu-item-<?php echo e($section['id']); ?>-<?php echo e($itemIndex); ?>"
                                        ...
                                        <div class="flex-1 flex items-center justify-between px-3 py-2 rounded-lg text-sm cursor-not-allowed opacity-50">
                                            <div class="flex items-center space-x-2">
                                                <span class="grayscale"><?php echo e($item['icon']); ?></span>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="flex items-center group" id="menu-item-<?php echo e($section['id']); ?>-<?php echo e($itemIndex); ?>">
                                        <a href="<?php echo e(route($item['route'])); ?>" wire:navigate
                                            ...
                                            :class="{
                                                'bg-<?php echo e($section['color']); ?>-500 text-white font-medium': currentPath && isRouteActive('<?php echo e(route($item['route'])); ?>'),
                                                'text-gray-400 hover:text-white hover:bg-gray-800': currentPath && !isRouteActive('<?php echo e(route($item['route'])); ?>'),
                                                'ring-2 ring-blue-400 ring-offset-1 ring-offset-gray-900': focusedSectionId === '<?php echo e($section['id']); ?>' && focusedItemIndex === <?php echo e($itemIndex); ?> && !isRouteActive('<?php echo e(route($item['route'])); ?>')
                                            }"
                                        ...
                                        <!-- Botón de favorito -->
                                        <button
                                            @click="toggleFavorite('<?php echo e($item['route']); ?>', '<?php echo e($item['label']); ?>', '<?php echo e($section['label']); ?>', '<?php echo e($item['icon']); ?>', '<?php echo e(route($item['route'])); ?>')"
                                            class="ml-2 p-1.5 rounded hover:bg-gray-800 transition opacity-0 group-hover:opacity-100">
                                            <svg class="w-4 h-4 transition"
                                                :class="isFavorite('<?php echo e($item['route']); ?>') ? 'text-yellow-500 fill-current' : 'text-gray-500'"
                                                fill="none"
                                                stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round"
...
<?php /**PATH C:\xampp\htdocs\bigmat\resources\views/components/sidebar-menu-enhanced.blade.php ENDPATH**/ ?>